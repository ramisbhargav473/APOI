...
public class UAT_CM_EC_ECus_TS01_TC01 extends DriverClass {
	...
	public void CM_EC_ECus_TS01_TC01(LinkedHashMap<String, Map<String, Map<String, String>>> finalDataMap) throws InterruptedException {

		customerIndex = sidePanel.clickCustomers();
		MethodsUtil.customWait();
		logger.info("Clicked on the Customers Tab from the Side Navigation");
		extentTest.pass("Clicked on 'Customers' tab from the Side Navigation bar and navigated to the Customer Index page");
