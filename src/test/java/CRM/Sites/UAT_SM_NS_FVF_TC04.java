 ...
 *
 * TC04 - Test Case 4
 ****1. Customer Index - Existing Customer from the prospect pop-up.
 ...
 *
 */
public class UAT_SM_NS_FVF_TC04 extends DriverClass{
	...
	public void SM_NS_FVF_TC04(LinkedHashMap<String, Map<String, Map<String, String>>> finalDataMap)
		...
		for (String testCaseID : finalDataMap.keySet()) {
			for (String sheetName : finalDataMap.get(testCaseID).keySet()) {
				...
				if (sheetName.equalsIgnoreCase(ConstantsUtil.CUSTOMER_INDEX_SHEET)) {
					...
					customerView = customerIndex.clickProceedExistingCustomer();
