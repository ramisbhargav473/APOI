...
public class SLC_LocatorsConstants {
	...
	public static final String SLC_MARGIN_RADIO = "create-service-line div[class='add_service_container'] div[class='container_right'] mat-radio-group";
	...
	public static final String SLC_MATERIAL_TYPE_DROPDOWN = "front-end-service div[class='full_card top_radius'] mat-form-field mat-select[formcontrolname='materialId'] div[class='mat-select-arrow']";
	public static final String SLC_ROUTE_DROPDOWN = "front-end-service div[class='full_card top_radius'] mat-form-field mat-select[formcontrolname='routeId'] div[class='mat-select-arrow']";
	public static final String SLC_ROUTE_DENSITY_DROPDOWN = "front-end-service div[class='full_card top_radius'] mat-form-field mat-select[formcontrolname='routeDensityId'] div[class='mat-select-arrow']";
	...
	public static final String SLC_DISPOSAL_SITE_DROPDOWN = "front-end-service div[class='full_card top_radius'] mat-form-field mat-select[formcontrolname='disposalCostId'] div[class='mat-select-arrow']";
